...
public final class Partie {
    ...
    public void initialiserCombats(){
        ...
        if(input.equals("go")){
            for(int i = 0; i < 5; i++){
                System.out.println("------------------------------ ZONE : " + this.listZones.get(i).getNomZone() + "----------------------------------");
                this.listZones.get(i).combattreZone();
            }
